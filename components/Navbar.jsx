...
const Navbar = () => {
  ...
  return (
    <nav
      className={`w-full flex items-center py-5 fixed top-0 ${scrolled ? "bg-primary z-20" : "bg-transparent z-20"
        }`}
    >
      <div className='w-full flex justify-start sm:justify-around items-center max-w-7xl mx-auto px-14 sm:px-1'>
        ...
        >
          <img src={'/anand-roy/anand.png'} alt='anand.png' className='w-9 h-9 object-contain bg-gray-200 rounded-full' />
